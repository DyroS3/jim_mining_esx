...
```sql
  INSERT INTO `items` (name, label, weight) VALUES
    ...
    ('diamond', 'diamond', 1),
    ('diamond_earring', 'diamond_earring', 1),
    ('diamond_earring_silver', 'diamond_earring_silver', 1),
    ('diamond_necklace', 'diamond_necklace', 1),
    ('diamond_necklace_silver', 'diamond_necklace_silver', 1),
    ('diamond_ring', 'diamond_ring', 1),
    ('diamond_ring_silver', 'diamond_ring_silver', 1),
    ('drillbit', 'drillbit', 1),
    ('emerald', 'emerald', 1),
    ('emerald_earring', 'emerald_earring', 1),
    ('emerald_earring_silver', 'emerald_earring_silver', 1),
    ('emerald_necklace', 'emerald_necklace', 1),
    ('emerald_necklace_silver', 'emerald_necklace_silver', 1),
    ('emerald_ring', 'emerald_ring', 1),
    ('emerald_ring_silver', 'emerald_ring_silver', 1),
    ('gold_earring', 'gold_earring', 1),
    ('gold_ring', 'gold_ring', 1),
    ('goldchain', 'goldchain', 1),
    ('goldingot', 'goldingot', 1),
    ('goldore', 'goldore', 1),
    ('goldpan', 'goldpan', 1),
    ('ironore', 'ironore', 1),
    ('miningdrill', 'miningdrill', 1),
    ('mininglaser', 'mininglaser', 1),
    ('pickaxe', 'pickaxe', 1),
    ('ruby', 'ruby', 1),
    ('ruby_earring', 'ruby_earring', 1),
    ('ruby_earring_silver', 'ruby_earring_silver', 1),
    ('ruby_necklace', 'ruby_necklace', 1),
    ('ruby_necklace_silver', 'ruby_necklace_silver', 1),
    ('ruby_ring', 'ruby_ring', 1),
    ('ruby_ring_silver', 'ruby_ring_silver', 1),
    ('sapphire', 'sapphire', 1),
    ('sapphire_earring', 'sapphire_earring', 1),
    ('sapphire_earring_silver', 'sapphire_earring_silver', 1),
    ('sapphire_necklace', 'sapphire_necklace', 1),
    ('sapphire_necklace_silver', 'sapphire_necklace_silver', 1),
    ('sapphire_ring', 'sapphire_ring', 1),
    ('sapphire_ring_silver', 'sapphire_ring_silver', 1),
    ('silver_earring', 'silver_earring', 1),
    ('silver_ring', 'silver_ring', 1),
    ('silverchain', 'silverchain', 1),
    ('silverearring', 'silverearring', 1),
    ('silveringot', 'silveringot', 1),
    ('silverore', 'silverore', 1),
    ('stone', 'stone', 1),
    ('uncut_diamond', 'uncut_diamond', 1),
    ('uncut_emerald', 'uncut_emerald', 1),
    ('uncut_ruby', 'uncut_ruby', 1),
    ('uncut_sapphire', 'uncut_sapphire', 1),
  ;
```